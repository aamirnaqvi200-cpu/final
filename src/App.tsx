...
>
  ...
  <div className="absolute inset-0 bg-black/0" />
      ...
      >
        ...
        >
          <div  
            className="text-[4rem] md:text-[10rem] lg:text-[20rem] font-bosenAlt text-yellow-500 select-none leading-none opacity-0 animate-fade-in-delayed"
            style={{
              animationDelay: '0.1s',  
              animationFillMode: 'forwards', 
...
<div className="relative mb-20 z-30">
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 max-w-5xl mx-auto">
    {[
      "https://ia801002.us.archive.org/18/items/shorts-2-part/inkwell%20carzyyyy2.mp4",
